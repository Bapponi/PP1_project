...
public class AllNamespaceList extends NamespaceList {

    private NamespaceList NamespaceList;
    private Namespace Namespace;

    public AllNamespaceList (NamespaceList NamespaceList, Namespace Namespace) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("AllNamespaceList(\n");
