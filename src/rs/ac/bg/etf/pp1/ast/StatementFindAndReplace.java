...
public class StatementFindAndReplace extends Statement {
    ...
    public StatementFindAndReplace (Designator Designator, Designator Designator1, Expr Expr, String farName, Expr Expr2) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("StatementFindAndReplace(\n");
